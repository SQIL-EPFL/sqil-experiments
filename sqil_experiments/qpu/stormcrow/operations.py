...
from sqil_experiments.qpu.stormcrow.qubit import Stormcrow
...
class StormcrowOperations(dsl.QuantumOperations):
    """Operations for Stormcrows."""

    QUBIT_TYPES = Stormcrow
    ...
    def barrier(self, q: Stormcrow) -> None:
    ...
    @dsl.quantum_operation
    def delay(self, q: Stormcrow, time: float) -> None:
    ...
    @dsl.quantum_operation
    def z90(self, q: Stormcrow, transition: str | None = None) -> None:
    ...
    @dsl.quantum_operation
    def z180(self, q: Stormcrow, transition: str | None = None) -> None:
    ...
    def active_reset(
        ...
        Arguments:
            ...
            measure_section_length:
                ...
                Default: None.
        """
        if isinstance(qubits, Stormcrow):
            qubits = [qubits]
