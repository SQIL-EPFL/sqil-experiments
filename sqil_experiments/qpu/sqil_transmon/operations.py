...
class SqilTransmonOperations(dsl.QuantumOperations):
    """Operations for SqilTransmons."""

    QUBIT_TYPES = SqilTransmon
    ...
    def barrier(self, q: SqilTransmon) -> None:
    ...
    @dsl.quantum_operation
    def delay(self, q: SqilTransmon, time: float) -> None:
    ...
    @dsl.quantum_operation
    def z90(self, q: SqilTransmon, transition: str | None = None) -> None:
    ...
    @dsl.quantum_operation
    def z180(self, q: SqilTransmon, transition: str | None = None) -> None:
    ...
    def active_reset(
        ...
        Arguments:
            ...
            measure_section_length:
                ...
                Default: None.
        """
        if isinstance(qubits, SqilTransmon):
            qubits = [qubits]
