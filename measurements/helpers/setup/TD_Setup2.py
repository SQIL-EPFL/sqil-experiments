...
# database path
db_path_local = (
    r"C:\Users\sqil\Desktop\data_local\HighTempFluxonium\HTT_a_N5\20241008_TD"
)
db_path = r"Z:\Projects\HighTempFluxonium\Samples\HTT_a_N5\data\20241008_TD"

# import param_dict
sys.path.append(
    r"Z:\Projects\HighTempFluxonium\Measurement\measurement_codes\helpers\param_dict"
)
from pd_20241008_HTT_a_N5_TD import param_dict, pd_file
...
vna_IP = r"TCPIP0::192.168.1.121::inst0::INSTR"  # AQUA ZNA26.5GHz
...
connections:
  device_shfqc:
    ...
    - iq_signal: q0/shfqc_drive_ef
      ports: SGCHANNELS/0/OUTPUT
    - iq_signal: q0/shfqc_third_drive
