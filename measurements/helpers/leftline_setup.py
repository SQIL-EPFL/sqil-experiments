from laboneq.simple import DeviceSetup, SHFQC, HDAWG, PQSC, create_connection
...
def get_device_setup() -> DeviceSetup:
    ...
    setup.add_instruments(
        ...
        HDAWG(uid="device_hdawg", address="dev9000", device_options="HDAWG8/MF/ME/SKW/PC"),
    ...
    setup.add_connections("device_hdawg",
        create_connection(to_signal="q0/flux_line", ports="SIGOUTS/0"),
    )

    setup.add_connections("device_pqsc",
