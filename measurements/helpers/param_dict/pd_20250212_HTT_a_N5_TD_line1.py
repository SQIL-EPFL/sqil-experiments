...
ro_freq = 3.384e9  # [Hz]
ro_freq_e = ro_freq - 12e6  # [Hz] # measuring |e> state
# qu_freq = 4.67444e9 #[Hz]
qu_freq = 4.6805e9  # At 140 mK
qu_freq_12 = 4.429e9
...
param_dict = {
    ...
    "ro_lo_freq": 3e9,  # ro_if_freq = ro_freq-ro_lo_freq
    "ro_pulse_length": 40e-6,  # [sec]
    "ro_power": 3,  # [dBm] ZInstrument output power
    "ro_acquire_range": -20,
    # external LO source (Signal core)
    "ro_exLO_freq": 17e9,  # 17.392e9-0.0e9, # This freq cannot be detuned by more than 500MHz from "ro_freq"
    ...
    "pulsed_onetone": {
        "ro_freq_step": 1e6,  # [Hz]
        "ro_freq_start": ro_freq - 250e6,  # [Hz]
        "ro_freq_stop": ro_freq + 250e6,  # [Hz] must be larger than start
        ...
        "avg": 1,  # 10000, # [#] or False (the same parameter in the higher nest will be used)
        "external_avg": 1,  # [#] or False (the same parameter in the higher nest will be used)
    },
    # pulsed twotone
    "pulsed_twotone": {
        "qu_freq_step": 0.05e6,  # [Hz]
        "qu_freq_start": qu_freq + 3e6,  # [Hz]
        "qu_freq_stop": qu_freq - 3e6,  # [Hz] must be larger than start
    ...
    "time_rabi": {
        ...
        "qu_pulse_length_stop": 300e-9,  # 80e-9,
        "qu_pulse_length_npts": 100,
        "sweep": False,  # "current", # str. name of the sweep parameter
    ...
    "qu_temp_amp_sweep": {
        ...
        "ef_pulse_amp_stop": 0.1681,  # 0.95,
        "ef_pulse_amp_npts": 2,
        "ef_pulse_length": 160e-9,
        "index_num": 100,
        "ro_freq": ro_freq_e,
        "reset_delay": 3 * T1,  # > 3*T1
        "avg": 2
    ...
    "single_shot": {
        ...
        "sweep": False,
        "reset_delay": 3 * T1,  # > 3*T1
        "external_avg": 10,  # [#] or False (the same parameter in the higher nest will be used)
    },
    "index": False,
    ...
    # sweep list
    "sweep_start": 17e9 - 50e6,
    "sweep_stop": 17e9 + 50e6,
    "sweep_npts": 26,
    "sweep_list": False,
