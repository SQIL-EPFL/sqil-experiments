...
param_dict = {
    "ro_freq": ro_freq,  # [Hz]
    "ro_lo_freq": 4e9,  # ro_if_freq = ro_freq-ro_lo_freq
    "ro_pulse_length": 2e-6,  # [sec]
    "ro_power": -5,  # [dBm] ZInstrument output power
    "ro_acquire_range": -40,
    # external LO source (Signal core)
    "ro_lo_plus_ro_exLO_freq": 20.2e9,  # This freq cannot be detuned by more than 500MHz from "ro_freq"
    ...
    "pulsed_onetone": {
        ...
        "sweep": "ro_lo_freq",  # "current", # str. name of the sweep parameter
