...
param_dict = {
    "ro_freq": ro_freq,  # [Hz]
    "ro_lo_freq": 2.7e9,  # ro_if_freq = ro_freq-ro_lo_freq
    "ro_pulse_length": 2e-6,  # [sec]
    "ro_power": -5,  # [dBm] ZInstrument output power
    "ro_acquire_range": -30,
    # external LO source (Signal core)
    "ro_lo_plus_ro_exLO_freq": 20e9,  # This freq cannot be detuned by more than 500MHz from "ro_freq"
    "ro_exLO_power": 20,  # [dBm]
    "qu_freq": qu_freq,
    ...
    "third_drive_power": 0,
    "third_drive_length": 1e-6,
    "third_drive_freq": 3e9,
    "third_drive_lo_freq": 2.6e9,
    "current": 0e-3,  # [A]
    # pulsed onetone
    "pulsed_onetone": {
        "ro_freq_step": 0.1e6,  # [Hz]
        "ro_freq_start": 20.345e9,  # [Hz]
        "ro_freq_stop": 20.365e9,  # [Hz] must be larger than start
