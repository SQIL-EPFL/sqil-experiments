...
from time_rabi import create_experiment, TimeRabiExperimentOptions
...
options = TimeRabiExperimentOptions(
    count=1024,
    transition="ge",
...
exp = create_experiment(qpu=qpu, qubit=qubit, pulse_lengths=pulse_lengths, options=options)
