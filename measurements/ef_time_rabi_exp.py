...
def main_exp(session, param_dict):
    ...
    ef_pulse_length_sweep = LinearSweepParameter(
        ...
        start=param_dict["ef_time_rabi"]["ef_pulse_length_start"],
        stop=param_dict["ef_time_rabi"]["ef_pulse_length_stop"],
        count=param_dict["ef_time_rabi"]["ef_pulse_length_npts"],
        ...
        with exp.sweep(
            ...
            with exp.section(
                ...
                exp.play(
                    signal="qu_drive_ef",
                    pulse=ef_pulse,
                    length=ef_pulse_length_sweep + 20e-9,
                    pulse_parameters={"width": ef_pulse_length_sweep},
                )
                # measurement
