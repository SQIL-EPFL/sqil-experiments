...
def main_exp(session, param_dict):
    ...
    ro_if_freq_sweep = LinearSweepParameter(
        ...
        start=param_dict["pulsed_onetone"]["ro_freq_start"] - param_dict["ro_lo_freq"],
        stop=param_dict["pulsed_onetone"]["ro_freq_stop"] - param_dict["ro_lo_freq"],
        count=param_dict["pulsed_onetone"]["ro_freq_npts"],
